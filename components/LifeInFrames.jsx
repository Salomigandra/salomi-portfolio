    ...
    <FullSlideWrapper bg="#FFF6EA" center={false}>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
        ...
        <div className="flex justify-center md:justify-start">
          <div className="relative max-w-md pl-8 pt-8 overflow-hidden">
            {/* Vertical line */}
            <span className="absolute top-0 left-0 h-full w-[2px] bg-[#1C1C1C]" />
            {/* Horizontal line crossing through -- clipped on mobile, full width on md+ */}
            <span className="absolute top-[20px] -left-[40px] w-[calc(100%+40px)] md:w-[130%] h-[2px] bg-[#1C1C1C]" />

            {/* Italian cursive phrase sitting above horizontal line */}
            <p className="absolute -top-8 left-4 text-xl md:text-3xl italic font-bold text-[#1C1C1C] font-[cursive]">
              ✨Momenti che parlano!
            </p>

            <p className="text-base md:text-2xl font-light leading-relaxed text-[#5A6E4F] mt-10">
